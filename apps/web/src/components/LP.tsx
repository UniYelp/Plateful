            ...
            <section className='px-4 py-20'>
                <div className='container mx-auto max-w-4xl text-center'>
                    ...
                    <p className='mx-auto mb-8 max-w-2xl text-balance text-muted-foreground text-xl'>
                        Transform your cooking experience with smart ingredient
                        management, personalized recipes, and seamless meal
                ...
                <div className='container mx-auto'>
                    <div className='mb-16 text-center'>
                        ...
                        <p className='mx-auto max-w-2xl text-muted-foreground text-xl'>
                            From ingredient tracking to meal planning, we've got
            ...
            <section id={SectionHash.HowItWorks} className='px-4 py-20'>
                <div className='container mx-auto'>
                    <div className='mb-16 text-center'>
                        ...
                        <p className='mx-auto max-w-2xl text-muted-foreground text-xl'>
                            Get started in minutes and transform your cooking
                            experience.
                        </p>
                    </div>
            ...
            <section className='bg-primary px-4 py-20 text-primary-foreground'>
                <div className='container mx-auto text-center'>
                    ...
                    <p className='mx-auto mb-8 max-w-2xl text-xl opacity-90'>
                        Join thousands of home cooks who've made cooking easier,
