...
export function PreferencesForm({
	...
	return (
		<form onSubmit={submitFormHandler(form)} className="w-full">
			<div className="space-y-6">
				...
				<div className="space-y-6 pb-8">
					<form.AppForm>
						...
						{/* Step 2: Spice Level & Dietary Preferences */}
						{step === 2 && (
							<div className="fade-in slide-in-from-bottom-8 animate-in space-y-6 duration-700">
								<div className="space-y-2 text-center">
									<h2 className="font-bold text-2xl">
														...
														<button
															...
															onClick={() => {
																if (form.state.value.includes(pref)) {
																	const index = form.state.value.indexOf(pref);
																	form.removeValue(index);
																} else {
																	form.pushValue(pref);
																}
												...
												{spiceLevelOption && (
													<div>
														...
														<Badge variant="outline" className="text-xs">
															{spiceLevelOption.emoji} {spiceLevelOption.label}
														</Badge>
													</div>
												)}
											</div>
