import type { HttpStatus } from "./http-status.type";

/**
 * @credit {@link https://github.com/prettymuchbryce/http-status-codes/blob/master/src/reason-phrases.ts}
 */
export const ReasonByHttpStatus = {
	/**
